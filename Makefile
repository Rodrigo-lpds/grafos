...
# Executáveis
all: menu_interativo menu_estudo_caso
...
# Menu estudo de caso (Bellman-Ford vs Dijkstra)
menu_estudo_caso: $(COMMON_OBJS) $(BUSCA_DIR)/dijkstra.o $(BUSCA_DIR)/bellman_ford.o menu_estudo_caso.o
	$(CXX) $(CXXFLAGS) -o $@ $^
...
clean:
	...
	rm -f menu_interativo teste_dijkstra menu_estudo_caso
	rm -f $(BUSCA_DIR)/*.txt
